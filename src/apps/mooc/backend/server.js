        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        var env = _this.express.get('env');
                        _this.httpServer = _this.express.listen(_this.port, function () {
                            console.log("  Mock Backend App is running at http://localhost:".concat(_this.port, " in ").concat(env, " mode"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        if (_this.httpServer) {
                            _this.httpServer.close(function (error) {
                                if (error) {
                                    reject(error);
                                    return;
                                }
